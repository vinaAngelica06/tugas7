...
//    @Scheduled(every ="5s")
    public void report() {
        ...
        try{
            connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/KebunPakDengklek", "postgres", "1111");
            Statement st = connection.createStatement();
            ResultSet resultSet = st.executeQuery("SELECT * FROM hasil_kebun");
            ...
            try {
                ...
                mailer.send(Mail.withText("vinaangelica06@gmail.com",
